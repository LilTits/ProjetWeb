                        ...
                        <div class="card mb-3"    >
                            <div class=" row no-gutters">
                                ...
                                <div class="col-6">
                                    ...
                                    <img src="/storage/image/products/{{$product->products->product_image}}" class="card-img-top img-thumbnail image_product"alt="Product">
                                </div>
                                <div class="col-md-12 btn-group">
                                    <a href="/products/{{$product->product_id}}" class="btn btn-primary">Retournez sur la page du produit</a>
                                    {!!Form::open(['action' => ['CartsController@destroy', $product->id], 'method' =>'POST'])!!}
