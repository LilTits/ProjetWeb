                ...
                <table class="table table-dark text-white">
                    ...
                    <tbody>
                        ...
                        <tr @if($user->admin) style="color: red" @endif>
                            ...
                            <td>
                                <a type="button" class="btn btn-warning btn-sm pull-right mr-2 invisible"
                                    data-toggle="tooltip" title="@lang(" Modifier l'utilisateur") {{ $user->name }}"><i
                                        class="fas fa-edit fa-lg"></i></a>
                            </td>
                            <td>
                                @unless($user->admin)
                                <a type="button" class="btn btn-danger btn-sm pull-right invisible"
                                    data-toggle="tooltip" title="@lang(" Supprimer l'utilisateur") {{ $user->name }}"><i
