...
<section id="event">
    <div class="event_section container">
        ...
        <div class="row">
            <div class="col-12">
                {!! Form::open(['action' => ['EventsController@update', $event->id], 'method' => 'POST', 'enctype' =>
                'multipart/form-data']) !!}
                ...
                <div class="form-group">
                    {{Form::label('max_participants', 'Nombre de places disponible')}}
                    {{Form::number('max_participants', $event->max_participants, [ 'class' => 'form-control' ])}}
                </div>
                <div class="form-group">
