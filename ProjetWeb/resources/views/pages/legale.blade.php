...
@section('content')
<!-- Start of legale section -->
<!-- 
    1.Mentions légales
    2.Protections des données personnelles
...
<section id="legale">
    <div class="container">
        ...
        <p>
            ...
            respect
            de la réglementation applicable en matière de protection des données à caractère personnel.
        ...
        <p>
            Par donnée à caractère personnel on entend toute information se rapportant à une personne identifiée ou
            identifiable, notamment par référence à des identifiants tels qu’un nom, un numéro d’identification, des
        ...
        <h5>Droits</h5>
        <p>
            En application de la réglementation européenne en vigueur, nous avons mis en place des procédures et
            mécanismes vous permettant d’exercer vos droits.
            ...
            droit de verrouillage ou de suppression des données des Utilisateurs à caractère personnel, lorsqu’elles
            sont inexactes, incomplètes, équivoques, périmées, ou dont la collecte, l’utilisation, la communication ou
        ...
        <p>
            Les présentes Conditions Générales de Vente déterminent les droits et obligations des parties dans le cadre
            de la vente en ligne de Produits ou Services proposés par le Vendeur.
        </p>
        ...
        <p>
            ...
            pour conclure le contrat par voie électronique pour pouvoir réaliser sa commande : – Information sur les
            caractéristiques essentielles du Produit ; – Choix du Produit, le cas échéant, de ses options - Indication
            des coordonnées essentielles du Client (identification, email, adresse…) ; – Acceptation des présentes
            Conditions Générales de Vente – Vérification des éléments de la commande (formalité du double clic) et, le
            cas échéant, correction des erreurs. Avant de procéder à sa confirmation, l’Acheteur a la possibilité de
            vérifier le détail de sa commande, son prix, et de corriger ses éventuelles erreurs, ou annuler sa commande.
            La confirmation de la commande emportera formation du présent contrat. – Ensuite, suivi des instructions
            pour le paiement, paiement des produits, puis livraison de la commande. Le Client recevra confirmation par
            courrier électronique du paiement de la commande, ainsi qu’un accusé de réception de la commande la
            confirmant. Il recevra un exemplaire .pdf des présentes conditions générales de vente.
            Le client disposera pendant son processus de commande de la possibilité d’identifier d’éventuelles erreurs
            commises dans la saisie des données et de les corriger. La langue proposée pour la conclusion du contrat est
            la langue française.
            Les modalités de l’offre et des conditions générales de vente sont renvoyées par email à l’acheteur lors de
            la commande et archivées sur le site web du Vendeur. Le cas échéant, les règles professionnelles et
            commerciales auxquelles l’auteur de l’offre entend se soumettre sont consultables dans la rubrique “règles
            annexes” des présentes CGV, consultables sur le site du Vendeur à l’adresse suivante : XXX
            L’archivage des communications, de la commande, des détails de la commande, ainsi que des factures est
            effectué sur un support fiable et durable de manière constituer une copie fidèle et durable conformément aux
            ...
            réalisation de la commande, le Client s’engage à fournir des éléments d’identification véridiques. Le
            Vendeur se réserve la possibilité de refuser la commande, par exemple pour toute demande anormale, réalisée
        ...
        <p>
            ...
            tous les cas, le montant total dû par l’Acheteur est indiqué sur la page de confirmation de la commande. Le
            prix de vente du produit est celui en vigueur indiqué au jour de la commande, celui-ci ne comportant par les
            frais de ports facturés en supplément. Ces éventuels frais sont indiqués à l’Acheteur lors du process de
            vente, et en tout état de cause au moment de la confirmation de la commande. Le Vendeur se réserve la
            possibilité de modifier ses prix à tout moment, tout en garantissant l’application du prix indiqué au moment
            de la commande. Lorsque les produits ou services ne sont pas exécutés immédiatement, une information claire
            est donnée sur la page de présentation du produit quant aux dates de livraison des produits ou services. Le
            client atteste avoir reçu un détail des frais de livraison ainsi que les modalités de paiement, de livraison
            et d’exécution du contrat, ainsi qu’une information détaillée relative à l’identité du vendeur, ses
            coordonnées postales, téléphoniques et électroniques, et à ses activités dans le contexte de la présente
            vente. Le Vendeur s’engage à honorer la commande du Client dans la limite des stocks de Produits disponibles
            uniquement. A défaut, le Vendeur en informe le Client ; si la commande a été passée, et à défaut d’accord
            ...
            l’adresse email communiquée).
        </p>
        <h5>Article 6 : Conformité</h5>
        <p>
            Conformément à l’article L.411-1 du Code de la consommation, les produits et les services offerts à la vente
            au travers des présentes CGV répondent aux prescriptions en vigueur relatives à la sécurité et à la santé
            des personnes, à la loyauté des transactions commerciales et à la protection des consommateurs.
            Indépendamment de toute garantie commerciale, le Vendeur reste tenu des défauts de conformité et des vices
            cachés du produit.
            ...
            Vendeur rembourse ou échange les produits défectueux ou ne correspondant pas à la commande. Le remboursement
            peut être demandé de la manière suivante : (décrire la procédure de remboursement, et comment le produit
            doit être retourné, et le remboursement des frais d’expédition le cas échéant).
        </p>
        ...
        <p>
            ...
            indiqués. Ces délais ne prennent pas en compte le délai de préparation de la commande. Lorsque la livraison
            nécessite une prise de rendez-vous avec le Client (décrire la procédure). Lorsque le Client commande
            plusieurs produits en même temps ceux-ci peuvent avoir des délais de livraison différents acheminés selon
            les modalités suivantes (décrire la procédure). En cas de retard d’expédition (décrire la procédure). En cas
            de retard de livraison, le Client dispose de la possibilité de résoudre le contrat dans les conditions et
            modalités définies à l’Article L 216-2 du Code de la consommation. Le Vendeur procède alors au remboursement
            du produit et aux frais « aller » dans les conditions des dispositions des articles L216-3 et le L241-4 du
            Code de la consommation. Le Vendeur met à disposition un point de contact téléphonique (coût d’une
            communication locale à partir d’un poste fixe) indiqué dans l’email de confirmation de commande afin
            d’assurer le suivi de la commande. Le Vendeur rappelle qu’au moment où le Client pend possession
            physiquement des produits, les risques de perte ou d’endommagement des produits lui sont transférés. Il
            appartient au Client de notifier au transporteur toute réserve sur le produit livré.
        </p>
        ...
        <h5>Article 10 : Paiement</h5>
        <p>
            Le paiement est exigible immédiatement à la commande, y compris pour les produits en précommande. Le Client
            peut effectuer le règlement par carte de paiement ou chèque bancaire. Les cartes émises par des banques
            domiciliées hors de France doivent obligatoirement être des cartes bancaires internationales (Mastercard ou
            Visa).Le paiement sécurisé en ligne par carte bancaire est réalisé par notre prestataire de paiement. Les
            informations transmises sont chiffrées dans les règles de l’art et ne peuvent être lues au cours du
            transport sur le réseau (décrire le process). Une fois le paiement lancé par le Client, la transaction est
            immédiatement débitée après vérification des informations. Conformément aux dispositions du Code monétaire
            et financier, l’engagement de payer donné par carte est irrévocable. En communiquant ses informations
            bancaires lors de la vente, le Client autorise le Vendeur à débiter sa carte du montant relatif au prix
            indiqué. Le Client confirme qu’il est bien le titulaire légal de la carte à débiter et qu’il est légalement
        ...
        <h5>Article 11 : Délai de rétractation</h5>
        <p>
            ...
            susmentionné, le prix du ou des produits achetés et les frais d’envoi seront remboursés, les frais de retour
            restant à la charge du Client. Les retours des produits sont à effectuer dans leur état d’origine et
            complets (emballage, accessoires, notice…) ; ils doivent si possible être accompagnés d’une copie du
            justificatif d’achat. Conformément aux dispositions légales, vous trouverez ci-après le formulaire type de
            rétractation à nous adresser à l’adresse suivante : (adresse). Procédure de remboursement : (décrire
            précisément la procédure de remboursement – en particulier pour les gros achats)
        </p>
        <h5>Article 12 : Garanties</h5>
        <p>
            Conformément à la loi, le Vendeur assume les garanties de conformité et relative aux vices cachés des
            produits. Le Vendeur rembourse l’acheteur ou échange les produits apparemment défectueux ou ne correspondant
            pas à la commande effectuée. La demande de remboursement doit s’effectuer de la manière suivante :
            (détailler la procédure) Le Vendeur rappelle que le consommateur : – dispose d’un délai de 2 ans à compter
            de la délivrance du bien pour agir auprès du Vendeur – qu’il peut choisir entre le remplacement et la
            réparation du bien sous réserve des conditions prévues par les dispositions susmentionnées. apparemment
            défectueux ou ne correspondant – qu’il est dispensé d’apporter la preuve l’existence du défaut de conformité
            du bien durant les six mois suivant la délivrance du bien. – que, sauf biens d’occasion, ce délai sera porté
            à 24 mois à compter du 18 mars 2016 – que le consommateur peut également faire valoir la garantie contre les
            vices cachés de la chose vendue au sens de l’article 1641 du code civil et, dans cette hypothèse, il peut
            choisir entre la résolution de la vente ou une réduction du prix de vente (dispositions des articles 1644 du
            Code Civil).
        </p>
        ...
        <p>
            La commande peut être résolue par l’acheteur par lettre recommandée avec demande d’avis de réception dans
            les cas suivants : — livraison d’un produit non conforme aux caractéristiques de la commande ; — livraison
            dépassant la date limite fixée lors de la commande ou, à défaut de date, dans les trente jours suivant le
            paiement ; — de hausse du prix injustifiée ou de modification du produit. Dans ces cas, l’acheteur peut
            exiger le remboursement de l’acompte versé majoré des intérêts calculés au taux légal à partir de la date
        ...
        <p>
            L’exécution des obligations du vendeur au terme des présentes est suspendue en cas de survenance d’un cas
            fortuit ou de force majeure qui en empêcherait l’exécution. Le vendeur avisera le client de la survenance
            d’un tel évènement dès que possible.
        </p>
        <h5>Article 17 : Nullité et modification du contrat</h5>
        <p>
        ...
        <h5>Article 18 : Protection des données personnelles</h5>
        <p>
            Conformément au Règlement 2016/679 du 27 avril 2016 relatif à la protection des personnes physiques à
            l’égard du traitement des données à caractère personnel et à la libre circulation de ces données, le Vendeur
            met en place un traitement de données personnelles qui a pour finalité la vente et la livraison de produits
            ...
            opérations de livraison et de vente ainsi que toute autorité légalement autorisée à accéder aux données
            personnelles en question - aucun transfert hors UE n’est prévu - la durée de conservation des données : le
            temps de la prescription commerciale - la personne concernée dispose du droit de demander au responsable du
            traitement l’accès aux données à caractère personnel, la rectification ou l’effacement de celles-ci, ou une
            limitation du traitement relatif à la personne concernée, ou du droit de s’opposer au traitement et du droit
            à la portabilité des données - La personne concernée a le droit d’introduire une réclamation auprès d’une
            autorité de contrôle - les informations demandées lors de la commande sont nécessaires à l’établissement de
            la facture (obligation légale) et la livraison des biens commandés, sans quoi la commande ne pourras pas
            être passée. Aucune décision automatisée ou profilage n’est mis en oeuvre au travers du processus de
            commande.
        </p>
        <h5>Article 19 : Droit applicable et clauses</h5>
        <p>
        ...
        <h5>Article 20 : Information des consommateurs</h5>
        <p>
            Aux fins d’information des consommateurs, les dispositions du code civil et du code de la consommation sont
            ...
            dans un délai de deux ans à compter de la découverte du vice. Dans le cas prévu par l’article 1642-1,
            l’action doit être introduite, à peine de forclusion, dans l’année qui suit la date à laquelle le vendeur
            ...
            Article L. 217-5 du Code de la consommation : Le bien est conforme au contrat : 1° S’il est propre à l’usage
            ...
            l’étiquetage ; 2° Ou s’il présente les caractéristiques définies d’un commun accord par les parties ou est
            propre à tout usage spécial recherché par l’acheteur, porté à la connaissance du vendeur et que ce dernier a
            accepté.
